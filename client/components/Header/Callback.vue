<template>
  <div class="callback flex flex_content-end flex_items-center">
    <div class="callback__text" :class="'callback__text_' + getHeaderTheme">
      <div class="callback__item" v-if="active == 'phone'">
        <a :href="'tel:' + getSetting.linkPhone">{{getSetting.phone}}</a>
      </div>
      <div class="callback__item" v-else>
        <a :href="'mailto:' + getSetting.email">{{getSetting.email}}</a>
      </div>
    </div>
    <div class="callback__icons">
      <div class="callback__icon" :class="active == 'phone' ? 'callback__icon_active' : ''">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" @click="changeActive('phone')"
        viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" :class="['callback_' + getHeaderTheme, active == 'phone' ? 'callback_active' : '']">
          <g>
            <g>
              <g>
      ...
      <div class="callback__icon" :class="active == 'mail' ? 'callback__icon_active' : ''">
        <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" @click="changeActive('mail')" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 511.974 511.974" style="enable-background:new 0 0 511.974 511.974" xml:space="preserve" :class="['callback_' + getHeaderTheme, active == 'mail' ? 'callback_active' : '']">
          <g>
            <g>
              <g>
...
export default {
  ...
  computed: {
    ...mapGetters(['getHeaderTheme', 'getSetting'])
  },
  methods: {
    changeActive(active) {
